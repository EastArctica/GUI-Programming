  ...
  $('#multiplication-form').validate({
    ...
    messages: {
      'x-start': {
        ...
        number: 'Please enter a valid number for X start.',
        min: 'X start must be greater than or equal to -100.',
        max: 'X start must be less than or equal to 100.'
      },
      'x-end': {
        required: 'Please enter an end value for X.',
        number: 'Please enter a valid number for X end.',
        min: 'X end must be greater than or equal to -100.',
        max: 'X end must be less than or equal to 100.'
      },
      'y-start': {
        required: 'Please enter a start value for Y.',
        number: 'Please enter a valid number for Y start.',
        min: 'Y start must be greater than or equal to -100.',
        max: 'Y start must be less than or equal to 100.'
      },
      'y-end': {
        required: 'Please enter an end value for Y.',
        number: 'Please enter a valid number for Y end.',
        min: 'Y end must be greater than or equal to -100.',
        max: 'Y end must be less than or equal to 100.'
      }
    },
    errorElement: 'div',
